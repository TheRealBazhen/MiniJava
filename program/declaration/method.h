...
public:
    MethodDecl(std::shared_ptr<Type> type, const std::string& name, std::shared_ptr<ArgumentDeclList> args, std::shared_ptr<StatementList> statements);
    MethodDecl(std::shared_ptr<Type> type, const std::string& name, std::shared_ptr<StatementList> statements);
